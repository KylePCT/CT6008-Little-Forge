...
Shader "Shader Forge/KT_SakuraBlossom" {
    Properties {
        ...
        _WindIntensity ("Wind Intensity", Range(0, 1)) = 0.06897079
        _WindSpeed ("Wind Speed", Range(0, 20)) = 3.924815
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_5327 = (o.vertexColor.r*((sin(mul(unity_ObjectToWorld, v.vertex).r)*((1.0 - o.uv0.g)*cos((node_4412.g*_WindSpeed_var))))*_WindIntensity_var));
                v.vertex.xyz += float3(node_5327,node_5327,node_5327);
...
/////// Diffuse:
                ...
                float3 diffuseColor = (_MainTex_var.rgb*_Color_var.rgb);
